...
// hidden fields not changeable on products page
  ...
  <div class="form-group row mb-3">
      <?php echo zen_draw_label(TEXT_PRODUCTS_RECORD_ARTIST, 'artists_id', 'class="col-sm-3 form-label"'); ?>
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_pull_down_menu('artists_id', $artists_array, $pInfo->artists_id, 'class="form-control" id="artists_id"'); ?>
    </div>
  </div>
  <div class="form-group row mb-3">
      <?php echo zen_draw_label(TEXT_PRODUCTS_RECORD_COMPANY, 'record_company_id', 'class="col-sm-3 form-label"'); ?>
    <div class="col-sm-9 col-md-6">
  ...
  <div class="form-group row mb-3">
      <?php echo zen_draw_label(TEXT_PRODUCTS_MUSIC_GENRE, 'music_genre_id', 'class="col-sm-3 form-label"'); ?>
    <div class="col-sm-9 col-md-6">
