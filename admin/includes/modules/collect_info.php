...
// hidden fields not changeable on products page
  ...
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_STATUS; ?></p>
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_status', '1', ($pInfo->products_status == 1), '', 'id="products_status1"'); ?>
            <label class="form-check-label" for="products_status1"><?php echo TEXT_PRODUCT_AVAILABLE; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_status', '0', ($pInfo->products_status == 0), '', 'id="products_status0"'); ?>
            <label class="form-check-label" for="products_status0"><?php echo TEXT_PRODUCT_NOT_AVAILABLE; ?></label>
        </div>
    </div>
  </div>
  <div class="form-group row mb-3">
      <?php echo zen_draw_label(TEXT_PRODUCTS_DATE_AVAILABLE, 'products_date_available', 'class="col-sm-3 form-label"'); ?>
    <div class="col-sm-9 col-md-6">
  ...
  <div class="form-group row mb-3">
      <?php echo zen_draw_label(TEXT_PRODUCTS_MANUFACTURER, 'manufacturers_id', 'class="col-sm-3 form-label"'); ?>
    <div class="col-sm-9 col-md-6">
  ...
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_NAME; ?></p>
    <div class="col-sm-9 col-md-6">
        <?php
...
?>
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCT_IS_FREE; ?></p>
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('product_is_free', '1', ($pInfo->product_is_free == 1), '', 'id="product_is_free1"'); ?>
            <label class="form-check-label" for="product_is_free1"><?php echo TEXT_YES; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('product_is_free', '0', ($pInfo->product_is_free == 0), '', 'id="product_is_free0"'); ?>
            <label class="form-check-label" for="product_is_free0"><?php echo TEXT_NO; ?></label>
        </div>
      <?php echo ($pInfo->product_is_free == 1 ? '<span class="help-block errorText">' . TEXT_PRODUCTS_IS_FREE_EDIT . '</span>' : ''); ?>
    </div>
  </div>
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCT_IS_CALL; ?></p>
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('product_is_call', '1', ($pInfo->product_is_call == 1), '', 'id="product_is_call1"'); ?>
            <label class="form-check-label" for="product_is_call1"><?php echo TEXT_YES; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('product_is_call', '0', ($pInfo->product_is_call == 0), '', 'id="product_is_call0"'); ?>
            <label class="form-check-label" for="product_is_call0"><?php echo TEXT_NO; ?></label>
        </div>
      <?php echo ($pInfo->product_is_call == 1 ? '<span class="help-block errorText">' . TEXT_PRODUCTS_IS_CALL_EDIT . '</span>' : ''); ?>
    </div>
  </div>
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES; ?></p>
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_priced_by_attribute', '1', ($pInfo->products_priced_by_attribute == 1), '', 'id="products_priced_by_attribute1"'); ?>
            <label class="form-check-label" for="products_priced_by_attribute1"><?php echo TEXT_PRODUCT_IS_PRICED_BY_ATTRIBUTE; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_priced_by_attribute', '0', ($pInfo->products_priced_by_attribute == 0), '', 'id="products_priced_by_attribute0"'); ?>
            <label class="form-check-label" for="products_priced_by_attribute0"><?php echo TEXT_PRODUCT_NOT_PRICED_BY_ATTRIBUTE; ?></label>
        </div>
...
?>
    <div class="form-group row mb-3">
        <?php echo zen_draw_label(TEXT_PRODUCTS_WHOLESALE_PRICE, 'products-price-w', 'class="col-sm-3 form-label"'); ?>
      <div class="col-sm-9 col-md-6">
...
?>
  ...
  <div class="form-group row mb-3">
    ...
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_virtual', '1', ($pInfo->products_virtual == 1), '', 'id="products_virtual1"'); ?>
            <label class="form-check-label" for="products_virtual1"><?php echo TEXT_PRODUCT_IS_VIRTUAL; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_virtual', '0', ($pInfo->products_virtual == 0), '', 'id="products_virtual0"'); ?>
            <label class="form-check-label" for="products_virtual0"><?php echo TEXT_PRODUCT_NOT_VIRTUAL; ?></label>
        </div>
      <?php echo ($pInfo->products_virtual == 1 ? '<span class="help-block errorText">' . TEXT_VIRTUAL_EDIT . '</span>' : ''); ?>
    </div>
  </div>
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_IS_ALWAYS_FREE_SHIPPING; ?></p>
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('product_is_always_free_shipping', '1', ($pInfo->product_is_always_free_shipping == 1), '', 'id="product_is_always_free_shipping1"'); ?>
            <label class="form-check-label" for="product_is_always_free_shipping1"><?php echo TEXT_PRODUCT_IS_ALWAYS_FREE_SHIPPING; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('product_is_always_free_shipping', '0', ($pInfo->product_is_always_free_shipping == 0), '', 'id="product_is_always_free_shipping0"'); ?>
            <label class="form-check-label" for="product_is_always_free_shipping0"><?php echo TEXT_PRODUCT_NOT_ALWAYS_FREE_SHIPPING; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('product_is_always_free_shipping', '2', ($pInfo->product_is_always_free_shipping == 0), '', 'id="product_is_always_free_shipping2"'); ?>
            <label class="form-check-label" for="product_is_always_free_shipping2"><?php echo TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING; ?></label>
        </div>
      <?php echo ($pInfo->product_is_always_free_shipping == 1 ? '<span class="help-block errorText">' . TEXT_FREE_SHIPPING_EDIT . '</span>' : ''); ?>
    </div>
  </div>
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_QTY_BOX_STATUS; ?></p>
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_qty_box_status', '1', ($pInfo->products_qty_box_status == 1), '', 'id="products_qty_box_status1"'); ?>
            <label class="form-check-label" for="products_qty_box_status1"><?php echo TEXT_PRODUCTS_QTY_BOX_STATUS_ON; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_qty_box_status', '0', ($pInfo->products_qty_box_status == 0), '', 'id="products_qty_box_status0"'); ?>
            <label class="form-check-label" for="products_qty_box_status0"><?php echo TEXT_PRODUCTS_QTY_BOX_STATUS_OFF; ?></label>
        </div>
  ...
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_MIXED; ?></p>
    <div class="col-sm-9 col-md-6">
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_quantity_mixed', '1', ($pInfo->products_quantity_mixed == 1), '', 'id="products_quantity_mixed1"'); ?>
            <label class="form-check-label" for="products_quantity_mixed1"><?php echo TEXT_YES; ?></label>
        </div>
        <div class="form-check form-check-inline">
            <?php echo zen_draw_radio_field('products_quantity_mixed', '0', ($pInfo->products_quantity_mixed == 0), '', 'id="products_quantity_mixed0"'); ?>
            <label class="form-check-label" for="products_quantity_mixed0"><?php echo TEXT_NO; ?></label>
        </div>
    </div>
  </div>
  <div class="form-group row mb-3">
      <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_DESCRIPTION; ?></p>
    <div class="col-sm-9 col-md-6">
        <?php
        for ($i = 0, $n = count($languages); $i < $n; $i++) {
          ?>
  ...
  <div class="form-group row mb-3">
      <?php echo zen_draw_label(TEXT_PRODUCTS_QUANTITY, 'products_quantity', 'class="col-sm-3 form-label"'); ?>
    <div class="col-sm-9 col-md-6">
  ...
  <div class="form-group row mb-3">
      <?php echo zen_draw_label(TEXT_PRODUCTS_MODEL, 'products_model', 'class="col-sm-3 form-label"'); ?>
    <div class="col-sm-9 col-md-6">
    ...
    if (!empty($pInfo->products_image)) { ?>
        ...
        <div class="form-group row mb-3">
            <p class="col-sm-3 form-label"><?php echo TEXT_IMAGES_DELETE; ?></p>
            <div class="col-sm-9 col-md-6">
                <div class="form-check form-check-inline">
                    <?php echo zen_draw_radio_field('image_delete', '0', true, '', 'id="image_delete0"'); ?>
                    <label class="form-check-label" for="image_delete0"><?php echo TABLE_HEADING_NO; ?></label>
                </div>
                <div class="form-check form-check-inline">
                    <?php echo zen_draw_radio_field('image_delete', '1', false, '', 'id="image_delete1"'); ?>
                    <label class="form-check-label" for="image_delete1"><?php echo TABLE_HEADING_YES; ?></label>
                </div>
            </div>
        </div>
    <?php }
    ?>
    <div class="form-group row mb-3">
        <?php echo zen_draw_label(TEXT_EDIT_PRODUCTS_IMAGE, 'products_image', 'class="col-sm-3 form-label"'); ?>
    ...
    ?>
    <div class="form-group row mb-3">
        <?php echo zen_draw_label(TEXT_UPLOAD_DIR, 'img_dir', 'class="col-sm-3 form-label"'); ?>
        <div class="col-sm-9 col-md-9 col-lg-6">
            <?php echo zen_draw_pull_down_menu('img_dir', $dir_info, $default_directory, 'class="form-control" id="img_dir"'); ?>
        </div>
    </div>
    <div class="form-group row mb-3">
        <p class="col-sm-3 form-label"><?php echo TEXT_IMAGES_OVERWRITE; ?></p>
        <div class="col-sm-9 col-md-9 col-lg-6">
            <div class="form-check form-check-inline">
                <?php echo zen_draw_radio_field('overwrite', '0', false, '', 'id="overwrite0"'); ?>
                <label class="form-check-label" for="overwrite0"><?php echo TABLE_HEADING_NO; ?></label>
            </div>
            <div class="form-check form-check-inline">
                <?php echo zen_draw_radio_field('overwrite', '1', true, '', 'id="overwrite1"'); ?>
                <label class="form-check-label" for="overwrite1"><?php echo TABLE_HEADING_YES; ?></label>
            </div>
        </div>
    </div>
    <div class="form-group row mb-3">
        <?php echo zen_draw_label(TEXT_PRODUCTS_IMAGE_MANUAL, 'products_image_manual', 'class="col-sm-3 form-label"'); ?>
        <div class="col-sm-9 col-md-9 col-lg-6">
    ...
    <hr>
  <div class="form-group row mb-3">
    <p class="col-sm-3 form-label"><?php echo TEXT_PRODUCTS_URL; ?><span class="help-block"><?php echo TEXT_PRODUCTS_URL_WITHOUT_HTTP; ?></span></p>
    <div class="col-sm-9 col-md-6">
        <?php
        for ($i = 0, $n = count($languages); $i < $n; $i++) {
          ?>
