...
?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="offset-sm-1 offset-md-3 offset-lg-4 col-xs-12 col-sm-10 col-md-6 col-lg-4 text-center">
                <div class="login-main-div login-box-shadow">
                    ...
                    <?php if (!isset($expired) || $expired == FALSE) { ?>
                        ...
                        <div class="form-group row mb-3 mb-2">
                            <div class="col-12">
                    ...
                    <i class="fa-solid fa-lg fa-lock"></i>
                        ...
                        <div class="login-forgot text-right">
                            <a href="<?php echo zen_href_link(FILENAME_PASSWORD_FORGOTTEN); ?>"
                               class="btn btn-secondary btn-sm"><?php echo TEXT_PASSWORD_FORGOTTEN; ?></a>
                        </div>
