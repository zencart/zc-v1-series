 ...
 * @version $Id: DrByte 2024 Jan 26 Modified in v2.0.0-alpha1 $
 */
    ...
    <div class="container-fluid">
        ...
        if ($action === 'edit' || $action === 'update') {
            ...
            <div class="formArea">
                ...
                ?>
                <div class="form-group row mb-3">
                    <?php echo zen_draw_label(ENTRY_POST_CODE, 'entry_postcode', 'class="col-sm-3 form-label"'); ?>
                    <div class="col-sm-9 col-md-6">
                        <?php
                        echo zen_draw_input_field(
                            'entry_postcode',
                ...
                if (ACCOUNT_STATE === 'true') {
                    ...
                    <div class="form-group row mb-3">
                        <?php
                        echo zen_draw_label(ENTRY_STATE, 'entry_state', 'class="col-sm-3 form-label"'); ?>
                        <div class="col-sm-9 col-md-6">
                            <?php
                            ...
                            <td class="dataTableContent text-center">
                                ...
                                <button type="submit" class="btn btn-status">
                                    ...
                                    if ($customer['customers_authorization'] === 0) {
                                        ?>
                                        <i class="fa-solid fa-check-square txt-status-on"
                                           title="<?php echo IMAGE_ICON_STATUS_ON; ?>"></i>
                                        <?php
                                    } else {
                                        ?>
                                        <i class="fa-solid fa-times-square txt-status-off"
                    ...
                    if (!empty($_GET['search'])) {
                        ...
                        <tr>
                            <td colspan="2" class="text-right">
                                <a href="<?php echo zen_href_link(FILENAME_CUSTOMERS); ?>" class="btn btn-secondary"
                                   role="button">
